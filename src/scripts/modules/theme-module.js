...
function closeNav() {
  ...
  document.getElementById('subNav').style.left = '-100%';
  document.getElementById('subNav2').style.left = '-100%';
}

function openSubNav() {
  document.getElementById('subNav').style.left = '0';
}

function openSubNav2() {
  document.getElementById('subNav2').style.left = '0';
}
